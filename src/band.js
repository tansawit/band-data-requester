...
async function getRequestProof(requestID) {
  const evmProofBytes = await axios.get(`${rpcURL}/oracle/proof/${requestID}`);
  return evmProofBytes.data.result.evmProofBytes;
}
